...
Laravel TestBench Core requires [PHP](https://php.net) 7, and supports [PHPUnit](https://phpunit.de/) 6. To get the latest version, simply require the project using [Composer](https://getcomposer.org):
